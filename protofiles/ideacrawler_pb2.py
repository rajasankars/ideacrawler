...
Status = _reflection.GeneratedProtocolMessageType('Status', (_message.Message,), dict(
  DESCRIPTOR = _STATUS,
  __module__ = 'protofiles.ideacrawler_pb2'
...
try:
  ...
  def beta_create_IdeaCrawler_server(servicer, pool=None, pool_size=None, default_timeout=None, maximum_timeout=None):
    ...
    request_deserializers = {
      ('protofiles.IdeaCrawler', 'AddDomainAndListen'): DomainOpt.FromString,
      ('protofiles.IdeaCrawler', 'AddPages'): PageRequest.FromString,
      ('protofiles.IdeaCrawler', 'CancelJob'): Subscription.FromString,
    }
    response_serializers = {
      ('protofiles.IdeaCrawler', 'AddDomainAndListen'): PageHTML.SerializeToString,
      ('protofiles.IdeaCrawler', 'AddPages'): Status.SerializeToString,
      ('protofiles.IdeaCrawler', 'CancelJob'): Status.SerializeToString,
    }
    method_implementations = {
      ('protofiles.IdeaCrawler', 'AddDomainAndListen'): face_utilities.unary_stream_inline(servicer.AddDomainAndListen),
      ('protofiles.IdeaCrawler', 'AddPages'): face_utilities.stream_unary_inline(servicer.AddPages),
      ('protofiles.IdeaCrawler', 'CancelJob'): face_utilities.unary_unary_inline(servicer.CancelJob),
    }
  ...
  def beta_create_IdeaCrawler_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
    ...
    generated only to ease transition from grpcio<0.15.0 to grpcio>=0.15.0"""
    request_serializers = {
      ('protofiles.IdeaCrawler', 'AddDomainAndListen'): DomainOpt.SerializeToString,
      ('protofiles.IdeaCrawler', 'AddPages'): PageRequest.SerializeToString,
      ('protofiles.IdeaCrawler', 'CancelJob'): Subscription.SerializeToString,
    }
    response_deserializers = {
      ('protofiles.IdeaCrawler', 'AddDomainAndListen'): PageHTML.FromString,
      ('protofiles.IdeaCrawler', 'AddPages'): Status.FromString,
      ('protofiles.IdeaCrawler', 'CancelJob'): Status.FromString,
    }
    cardinalities = {
    ...
    return beta_implementations.dynamic_stub(channel, 'protofiles.IdeaCrawler', cardinalities, options=stub_options)
except ImportError:
  pass
